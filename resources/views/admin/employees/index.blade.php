...
<body>
    ...
    <div class="container">
        ...
        <div class="table-container">
                    ...
                    <tbody>
                        @foreach($employees as $employee)
                            <tr>
                                ...
                                <td>
                                    <div class="actions">
                                        <a href="{{ route('admin.employees.edit', $employee->id) }}" class="btn btn-edit">✏️ Edit</a>
            ...
            @else
                <p style="text-align: center; padding: 40px; color: #666;">No employees found. <a href="{{ route('admin.employees.create') }}" style="color: #667eea;">Add one now</a></p>
            @endif
        </div>
    </div>
</body>
