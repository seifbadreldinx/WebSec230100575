    ...
    <div class="container">
        <div class="form-container">
            <div class="form-header">
                ...
                <a href="{{ route('employee.products') }}" style="color: #28a745; text-decoration: none;">← Back to Products</a>
            </div>
            ...
            <form action="{{ route('employee.products.update', $product->id) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('employee.products') }}" class="btn btn-secondary">
                        Cancel
                    </a>
                </div>
            </form>
