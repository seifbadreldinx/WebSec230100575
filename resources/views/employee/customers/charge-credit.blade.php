    ...
    <div class="container">
        <div class="form-container">
            <div class="form-header">
                ...
                <a href="{{ route('employee.customers') }}" style="color: #28a745; text-decoration: none;">← Back to Customers</a>
            </div>
            ...
            <form action="{{ route('employee.customers.charge-credit.store', $customer->id) }}" method="POST">
                @csrf
                ...
                <div class="form-actions">
                    ...
                    <a href="{{ route('employee.customers') }}" class="btn btn-secondary">
                        Cancel
                    </a>
                </div>
            </form>
