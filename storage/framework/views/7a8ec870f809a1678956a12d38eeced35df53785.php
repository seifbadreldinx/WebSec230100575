...
<body>
    ...
    <div class="container">
        <a href="<?php echo e(route('products.index')); ?>" class="back-link">← Back to Products</a>
        ...
        <div class="product-detail">
            ...
            <div class="product-info-section">
                ...
                <div class="product-stock <?php echo e($product->stock > 0 ? 'in-stock' : 'out-of-stock'); ?>">
                ...
                <div class="product-meta">
                    ...
                    <div class="meta-item">
                        ...
                        <span class="meta-value"><?php echo e($product->category->name); ?></span>
                    </div>
                    <div class="meta-item">
                        <span class="meta-label">Price</span>
                        <span class="meta-value">$<?php echo e(number_format($product->price, 2)); ?></span>
                    </div>
                    <div class="meta-item">
                        <span class="meta-label">Availability</span>
                        <span class="meta-value"><?php echo e($product->stock); ?> units</span>
                    </div>
                </div>
                            ...
                            <?php if($product->stock > 0): ?>
                                <form action="<?php echo e(route('products.buy', $product->id)); ?>" method="POST">
                                    ...
                                    <div class="quantity-selector">
                                        ...
                                        <input type="number" name="quantity" id="quantity" value="1" min="1" max="<?php echo e($product->stock); ?>" required>
                                        <span>Max: <?php echo e($product->stock); ?></span>
                                    </div>
                                    <button type="submit" class="btn">
                                        🛒 Buy Now - $<?php echo e(number_format($product->price, 2)); ?>
...
<?php /**PATH C:\xampp\htdocs\MidTerm230100575\resources\views/products/show.blade.php ENDPATH**/ ?>