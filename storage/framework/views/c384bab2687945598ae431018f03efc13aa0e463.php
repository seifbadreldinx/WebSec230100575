    ...
    <div class="container">
        ...
        <div class="product-info">
            ...
            <div class="info-row">
                ...
                <span class="value price">$<?php echo e(number_format($required, 2)); ?></span>
            </div>
            
            <div class="info-row">
                <span class="label">Your Current Credit:</span>
                <span class="value current">$<?php echo e(number_format($current, 2)); ?></span>
            </div>
            
            <div class="info-row">
                <span class="label">You Need:</span>
                <span class="value shortage">$<?php echo e(number_format($shortage, 2)); ?></span>
            </div>
        </div>
        ...
        <div class="buttons">
            ...
            <a href="<?php echo e(route('products.my-purchases')); ?>" class="btn btn-secondary">
                My Purchases
            </a>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\MidTerm230100575\resources\views/products/insufficient-credit.blade.php ENDPATH**/ ?>