                    ...
                    <div class="product-card">
                        ...
                        <?php if(auth()->check() && auth()->user()->isCustomer()): ?>
                            <?php if($product->stock > 0): ?>
                                <form action="<?php echo e(route('products.buy', $product->id)); ?>" method="POST" style="margin-top: 10px;">
                                    <?php echo csrf_field(); ?>
                                    <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 10px;">
                                        <label for="quantity_<?php echo e($product->id); ?>" style="font-weight: 600; margin: 0;">Qty:</label>
                                        <input 
                                            type="number" 
                                        ...
                                        >
                                        <span style="color: #666; font-size: 13px;">(Max: <?php echo e($product->stock); ?>)</span>
                                    </div>
